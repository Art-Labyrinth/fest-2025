        ...
        <div className="flex flex-col min-h-screen bg-main">
            ...
            ">
                ...
                <div className="flex flex-col relative px-4 z-10 max-w-lg mx-auto">
                    ...
                    <div className="absolute flex w-32 transform -rotate-90 left-44 sm:left-48 top-20 sm:top-5">
                        <img src="https://files.art-labyrinth.org/fest2025/svg/moon-white.svg?v=1" alt="" />
                    </div>
                </div>
            </div>
