        ...
        <section className="py-12 bg-[#F4E4C3]">
          <div className="container mx-auto px-4 flex flex-col items-center">
            <div className="flex gap-6 mb-6">
              ...
              >
                <img src={`${process.env.PUBLIC_URL}/Participants/rules.png`} alt="Rules" className="w-20 h-20" />
              ...
              <button onClick={() => setIsTraditionsPopupOpen(true)}
                className="flex sm:flex-col flex-col items-center justify-center gap-3">
                <img src={`${process.env.PUBLIC_URL}/Participants/traditions.png`} alt="Traditions" className="w-20 h-20" />
