...
export default function Programma() {
  ...
  return (
    <>
      ...
      <div className="flex align-middle justify-center w-[100%] max-w-[100%] h-[37vw] md:h-[29vw] ml-auto mr-auto bg-cover" style={{backgroundImage: `url(${process.env.PUBLIC_URL}/Programma/banner.jpg)`}}>
      ...
      <div className="px-4 w-[1730px] max-w-[100%] mt-0 mb-0 ml-auto mr-auto">
        ...
        <div className="columns-1 lg:columns-2 gap-[40px]">
          ...
          <img className="width-[692px] max-w-[100%] ml-auto mr-auto" src={`${process.env.PUBLIC_URL}/Programma/tree.png`} alt=""/>
