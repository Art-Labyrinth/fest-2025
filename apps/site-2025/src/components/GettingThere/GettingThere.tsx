...
export default function GettingThere() {
  ...
  return (
    <>
      ...
      <div className="flex align-middle justify-center w-[100%] max-w-[100%] h-[37vw] md:h-[29vw] ml-auto mr-auto bg-cover" style={{backgroundImage: `url(${process.env.PUBLIC_URL}/GettingThere/banner.jpg)`}}>
